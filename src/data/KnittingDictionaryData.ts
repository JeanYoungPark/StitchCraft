...
export const knittingTermsData: KnittingTerm[] = [
  ...
  },
  {
    ...
    category: 'basic',
    definition:
      '가로로 한 줄을 뜬 것을 말합니다. 앞뜨기와 뒤뜨기가 한 세트입니다.',
  ...
  },
  {
    ...
    category: 'tool',
    definition:
      '직선형 바늘로 평면 뜨개질에 사용됩니다. 보통 2개를 한 세트로 사용합니다.',
  ...
  },
  {
    ...
    category: 'technique',
    definition:
      '10cm x 10cm 정사각형 안에 들어가는 코와 단의 개수를 측정하는 것입니다.',
  ...
  },
  {
    ...
    category: 'stitch',
    definition:
      '메리야스뜨기와 안뜨기를 교대로 하여 탄력있는 조직을 만드는 기법입니다.',
  ...
  },
  {
    ...
    category: 'material',
    definition:
      '합성섬유 실로 가격이 저렴하고 세탁이 쉬워 초보자에게 인기입니다.',
  ...
  },
  {
    ...
    category: 'tool',
    definition:
      '특정 위치를 표시하는 도구로 패턴의 반복 구간을 표시할 때 사용합니다.',
...
export const getTermsByCategory = (
  category: KnittingTerm['category'] | 'all',
) => {
...
// 난이도별 필터링 함수
export const getTermsByDifficulty = (
  difficulty: KnittingTerm['difficulty'] | 'all',
) => {
...
export const searchTerms = (query: string) => {
  ...
  return knittingTermsData.filter(
    term =>
