...
export const defaultPatterns: PatternDataInterface[] = [
  {
    ...
    youtubeCredit: {
      ...
      channel: {
        name: '코바늘 뜨개사 홀리',
        handle: '',
        url: 'https://www.youtube.com/@코바늘뜨개사홀리',
        verified: false,
      },
      duration: '53:34',
  ...
  {
    patternId: 'cute-fish-bread-keyring',
    title: '더 귀엽고 쉽게 리뉴얼된 코바늘 붕어빵 키링 | 홀리랜드 DIY 키트',
    difficulty: '초급',
    duration: '1-2시간',
    description: '',
    materials: [],
    ...
    youtubeCredit: {
      videoId: 'ljVJVGKpNzQ',
      videoUrl: 'https://www.youtube.com/watch?v=ljVJVGKpNzQ',
      title: '더 귀엽고 쉽게 리뉴얼된 코바늘 붕어빵 키링 | 홀리랜드 DIY 키트',
      channel: {
        name: '코바늘 뜨개사 홀리',
        handle: '',
      ...
      productLinks: [
        {
          type: 'kit',
          title: '홀리랜드 DIY키트',
          description: '붕어빵 키링 만들기에 필요한 모든 재료가 포함된 키트',
          url: '',
          price: '',
          currency: '',
          affiliate: false,
