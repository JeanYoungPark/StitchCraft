...
const NeedleGuideScreen: React.FC = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState<'knitting' | 'crochet' | 'circular'>('knitting');
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        ...
        <TouchableOpacity 
          style={[styles.tab, selectedCategory === 'circular' && styles.activeTab]}
          onPress={() => setSelectedCategory('circular')}
        >
          <Text style={[styles.tabText, selectedCategory === 'circular' && styles.activeTabText]}>
            원형바늘
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            ...
            {knittingNeedles.map((needle, index) => (
              <View key={index} style={styles.needleCard}>
                <View style={styles.needleHeader}>
                  ...
                  <Text style={styles.needleDifficulty}>{needle.difficulty}</Text>
                </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.crochetInfo}>
              ...
              <View style={styles.infoList}>
                <Text style={styles.infoText}>• 한 번에 하나의 고리만 작업</Text>
        ...
        {selectedCategory === 'circular' && (
          <View style={styles.section}>
            ...
            <View style={styles.circularInfo}>
              ...
              <View style={styles.infoList}>
                <Text style={styles.infoText}>• 이음새 없는 원형 작품 제작</Text>
                <Text style={styles.infoText}>• 무거운 작품도 편안하게 작업</Text>
            ...
            {circularNeedles.map((needle, index) => (
              <View key={index} style={styles.circularCard}>
                ...
                <Text style={styles.circularUses}>주요 용도: {needle.uses}</Text>
            ...
            <View style={styles.magicLoopSection}>
              ...
              <Text style={styles.magicLoopDescription}>
                긴 원형바늘(80cm 이상)을 사용해서 작은 원형 작품도 만들 수 있는 기법입니다.
                양말이나 모자 같은 작은 작품을 40cm 바늘 없이도 만들 수 있어 매우 유용해요.
              </Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.tipsSection}>
          ...
          <View style={styles.tipsList}>
            <Text style={styles.tipText}>• 처음에는 5-6mm 바늘부터 시작하세요</Text>
            <Text style={styles.tipText}>• 대나무, 금속, 플라스틱 소재별로 특징이 달라요</Text>
            <Text style={styles.tipText}>• 실 라벨의 권장 바늘 호수를 확인하세요</Text>
            <Text style={styles.tipText}>• 세트로 구매하면 경제적이에요</Text>
            <Text style={styles.tipText}>• 끝이 뾰족한 바늘이 작업하기 편해요</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
